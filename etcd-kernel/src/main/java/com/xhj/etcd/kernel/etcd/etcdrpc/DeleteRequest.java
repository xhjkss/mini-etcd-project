 ...
 *
 * @author XJks
 * @description 当前阶段 MVCC KV 骨架的 DELETE 请求，用于删除指定 key。
 *
 * <p>阶段边界：</p>
 * <p>该类只服务于当前 MVCC KV 骨架与 Raft/RPC 联调闭环</p>
 *
 * <p>处理流程：</p>
 ...
 * <p>4) 日志 committed 并 apply 后，MVCC KV 状态机按 key 删除对应数据，并返回 DeleteResponse。</p>
 */
@Data
