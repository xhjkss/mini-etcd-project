 ...
 * PUT、DELETE、GET、RANGE、DELETE_RANGE 等具体操作的返回数据放在 body 中。</p>
 *
 * <p>职责边界：</p>
 * <ul>
 *     <li>header：保存 success、notLeader、leaderId、message 等通用元信息。</li>
 *     <li>body：保存具体业务响应，例如 PutResponse、DeleteResponse、GetResponse、RangeResponse、DeleteRangeResponse。</li>
...
public class EtcdRpcResponse<T> implements Serializable {
     ...
     *
     * <p>当前阶段 PUT、DELETE、GET、RANGE、DELETE_RANGE 都会经过 Raft propose 和 apply。
